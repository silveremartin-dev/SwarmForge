 ...
 * @author Jeff Dinkins
 */
public class SimulationModule extends JAntsModule {
    int windowCount = 0;
    ...
    public SimulationModule(JAnts jAntsApplication) {
        super(jAntsApplication, "InternalFrameDemo", "toolbar/JDesktop.gif");
    ...
    class ShowFrameAction extends AbstractAction {
        SimulationModule demo;
        Icon icon;


        public ShowFrameAction(SimulationModule demo, Icon icon) {
            this.demo = demo;
            this.icon = icon;
        }
    ...
    class ImageScroller extends JScrollPane {
        ...
        public ImageScroller(SimulationModule demo, Icon icon, int layer, int count) {
            super();
            JPanel p = new JPanel();
