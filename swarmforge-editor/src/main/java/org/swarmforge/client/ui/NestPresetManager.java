...
public class NestPresetManager {
    ...
    private Map<String, Object> make(String name, String speciesModel, int nestStageIndex, String taxon, String genus, String arch, String mat, double workerSizeMm,
