...
## Executive Summary
This document provides a comprehensive technical and biological reference for the **220+ eusocial insect behavioral systems** implemented within the SwarmForge v2.0 simulation framework. The 30 primary behavioral systems detailed below represent core ecological archetypes.

In SwarmForge v2.0 ECS, all 220+ behaviors are packed into a **256-bit bitmask** (`EthologyComponent` using 4 × 64-bit primitive `long` fields: `caps0`, `caps1`, `caps2`, `caps3`), dispatched with zero memory allocation ($O(1)$) by `EthologyEcsSystem`.

---

## Comprehensive Catalog of Core Eusocial Behaviors

### 1. Geomagnetic Navigation (`MagnetoreceptionSystem`)
* **Capability Flag**: `W0_MAGNETORECEPTION`
...
* **Capability Flag**: `W1_APHID_FARMING`
...
* **Capability Flag**: `W0_ROYAL_INHIBITION`
...
* **Capability Flag**: `W0_SUBSTRATE_ACOUSTIC`
...
* **Capability Flag**: `W0_POLYCALIC_NETWORK`
...
* **Capability Flag**: `W2_PROPOLIS_SHIELD`
...
* **Capability Flag**: `W2_WEAVER_SILK`
...
* **Capability Flag**: `W2_FUNGUS_WEEDING`
...
* **Capability Flag**: `W1_STERCORAL_CEMENT`
...
* **Capability Flag**: `W0_PROCTODEAL_TROPHALLAXIS`
...
* **Capability Flag**: `W1_EVAPORATIVE_COOLING`
* **Key Species**: *Apis mellifera*
...
* **Capability Flag**: `W2_DULOSIS_RAID`
...
* **Capability Flag**: `W2_LIVING_BIVOUAC`
...
* **Capability Flag**: `W1_SOLAR_MOUND`
...
* **Capability Flag**: `W0_ALLOGROOMING`
...
* **Capability Flag**: `W0_TREMBLE_DANCE`
* **Key Species**: *Apis mellifera*
...
* **Capability Flag**: `W1_THERMAL_TRAIL_DECAY`
...
* **Capability Flag**: `W1_THORACIC_INCUBATION`
...
* **Capability Flag**: `W2_RITUAL_JOUSTING`
...
* **Capability Flag**: `W2_TERRITORIAL_REPELLENT`
...
* **Capability Flag**: `W2_FLOOD_EVACUATION`
...
* **Capability Flag**: `W0_STRIDULATION_RESCUE`
...
* **Capability Flag**: `W1_HONEYPOT_STORAGE`
...
* **Capability Flag**: `W1_GRAVEL_PLUGGING`
...
* **Capability Flag**: `W2_OLEIC_ACID_NECROPHORESIS`
...
* **Capability Flag**: `W0_UV_POLARIZED_NAV`
...
To maintain high performance ($60\,\text{FPS}$) during large-scale simulations (scaling towards 1,000,000 active agents):
1. **256-Bit Bitmasking (`EthologyComponent`)**: Capabilities are stored as 4 primitive `long` fields (`caps0`, `caps1`, `caps2`, `caps3`), giving instant $O(1)$ capability checking without collection overhead.
2. **Tick Sampling Heuristics**: Expensive spatial searches in `EthologyEcsSystem`, `ParasiteSystem`, and `TrophallaxisSystem` run every 5 ticks rather than every frame.
3. **Open-Addressing Spatial Grid**: `SpatialPartitioningSystem` uses a zero-allocation flat array structure to maximize CPU L1/L2 cache locality.
