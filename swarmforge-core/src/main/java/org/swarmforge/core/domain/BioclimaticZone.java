...
public enum BioclimaticZone {
    ...
    TROPICAL_RAINFOREST("🌴 Forêt Tropicale Humide", 25.0f, 2200.0f, 85.0f,
    ...
    BOREAL_TAIGA("🌲 Forêt Boréale / Taïga", 2.0f, 600.0f, 70.0f,
            Map.of(TreeSpecies.PINE, 60, TreeSpecies.BIRCH, 30, TreeSpecies.DEAD_LOG, 10),
            "Formica lugubris, Camponotus herculeanus"),

    ARCTIC_TUNDRA("❄️ Toundra & Permafrost Arctique", -8.0f, 300.0f, 50.0f,
