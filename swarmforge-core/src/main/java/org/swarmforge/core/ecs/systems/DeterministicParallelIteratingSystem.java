 ...
 */
public abstract class DeterministicParallelIteratingSystem extends EntityProcessingSystem {
    ...
    @Override
    protected void processEntities(com.artemis.utils.IntBag entities) {
