...
package org.jants.ui;import javax.accessibility.Accessible;
...
public class StatisticsModule extends JAntsModule {
    JTable      tableView;
     ...
     */
    public StatisticsModule(JAnts jAntsApplication) {
        super(jAntsApplication, "TableDemo", "toolbar/JTable.gif");
        ...
        getModulePanel().add(controlPanel, BorderLayout.NORTH);
        ...
        getModulePanel().add(tableAggregate, BorderLayout.CENTER);
        ...
        getModulePanel().getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT)
            .put(KeyStroke.getKeyStroke("ctrl P"), "print");

        getModulePanel().getActionMap().put("print", new AbstractAction() {
            public void actionPerformed(ActionEvent ae) {
                printTable();
            }
        });
