...
public final class MeatAntSpecies extends AbstractEusocialInsectSpecies {
    ...
    @Override
    //avoid calling this method, prefer getIndividual(int sex, int stage, int scentId, int x, int y, int z)
    public MeatAntIndividual getIndividual(int x, int y, int z) {
        return new MeatAntIndividual(this, 0, 0, 0);
    }

    public MeatAntIndividual getIndividual(int sex, int stage, int scentId, int x, int y, int z) {
