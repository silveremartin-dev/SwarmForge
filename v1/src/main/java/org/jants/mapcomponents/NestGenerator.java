...
public class NestGenerator {
    ...
    public Graph getNest(int nestType, int nestArchitecture, int numChambers) {
    ...
    */
    public Set<TerrariumCell> generateNest(String lsystem) {
    ...
    */
    public void DDA(int x0, int x1, int y0, int y1) {
        int dx = x1 - x0;
        int dy = y1 - y0;
    ...
    public float changeHeading(Nest nest, char direction) {
        float newHeading;
    ...
    public void buildChamber(Nest nest) {
    ...
    public void readSystem(Nest nest, String lsystem) {
        Stack<Nest> s;
