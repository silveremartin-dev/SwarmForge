...
public class TerrariumCell implements Serializable {
    ...
    public double x; // x index of the cell in the map
    public double y; // y index of the cell in the map
    public double z; // z index of the cell in the map
    ...
    public TerrariumCell(int x, int y, int z) {
        ...
        fillLevel = fillFull;
        scents = new int[19]; // we should avoid having a fixed size as the array may grow
    ...
    public int getId() {
        // it would be nice to use UUID.randomUUID() or may be "system time", through System.nanoTime(), though we would still need to convert it to int without taking the risk of generating duplicates
        // easier and faster it to use a static field
        return id;
    }

    private int getCellTypeIndex(int cellType) {
        switch (cellType) {
            case contentsAir : return 0;
            case contentsIce : return 1;
            case contentsSnow : return 2;
            case contentsWater : return 3;
            case contentsRock : return 4;
            case contentsSand : return 5;
            case contentsClay : return 6;
            case contentsWood : return 7;
            case contentsLeaves : return 8;
            case contentsFungus : return 9;
            case contentsSugar : return 10;
            case contentsFat : return 11;
            case contentsMeat : return 12;
            case contentsPoison : return 13;
            case contentsBiologicalWaste : return 14;
    ...
    private int getScentTypeIndex(int scentType) {
        switch (scentType) {
            case scentSugar : return 0;
            case scentMeat : return 1;
            case scentFat : return 2;
            case scentDecay : return 3;
            case scentHumidity : return 4;
            case scentPoison : return 5;
            case scentBattle : return 6;
            case scentBurnt : return 7;
            case scentPoop : return 8;
            case scentDump : return 9;
            case scentBrood : return 10;
            case scentFungus : return 11;
            case scentLeaves : return 12;
            case scentNest : return 13;
            case scentCo2 : return 14;
            case scentMethane : return 15;
            case scentNitrousOxide : return 16;
            case scentOtherEnemy : return 17;
            case scentOtherFriendly : return 18;
